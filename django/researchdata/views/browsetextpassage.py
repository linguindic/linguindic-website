...
class BrowseTextPassageDetailView(DetailView):
    """
    Class-based view to show the text passage detail template
    """
    template_name = 'researchdata/browse-textpassage-detail.html'
    model = models.TextPassage


class BrowseTextPassageListView(ListView):
    """
    Class-based view to show the text passage list template
    """
    template_name = 'researchdata/browse-textpassage-list.html'
    model = models.TextPassage
    paginate_by = 30
    ...
    def get_context_data(self, **kwargs):
        ...
        context = super(BrowseTextPassageListView, self).get_context_data(**kwargs)
        # Add data for related models
        context = common.add_main_models_to_context(context, 'textpassage')
